...
export const TyEventKindMap = {
    ...
    [TyEventType.ENEMY_CREATE_SKY_BOTTOM_50]: EnemyCreate,
    ...
    [TyEventType.ENEMY_CREATE_TOP_BOTTOM_50]: EnemyCreate,
