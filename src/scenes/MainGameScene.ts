...
import {Sprite, Texture, ObservablePoint, IPointData} from "pixi.js";
...
export class MainGameScene extends AbstractScene<DemoParams> {
    ...
    private readonly back1Pos: IPointData;
    private readonly back2Pos: IPointData;
    private readonly back3Pos: IPointData;
    ...
    public update (delta: number): void {
        this.updateMapPos(delta);
    }

    private updateMapPos (delta: number) {
        let dy = delta*this.timeCompression;
        this.back1Pos.y += dy*this.back1Speed;
        this.back2Pos.y += dy*this.back2Speed;
        this.back3Pos.y += dy*this.back3Speed;
    }
}
